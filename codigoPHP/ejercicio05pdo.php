...
<html>
    ...
    <body>
        ...
        //insert 
            $insert1 = 'INSERT INTO Departamento VALUES (UPPER("pr1"), "Prueba 1", NOW(), null, 1000)';
            $insert2 = 'INSERT INTO Departamento VALUES (UPPER("pr2"), "Prueba 2", NOW(), null, 2000)';
            $insert3 = 'INSERT INTO Departamento VALUES (UPPER("pr3"), "Prueba 3", NOW(), null, 3000)';
        ...
        try {
            ...
            $insertarDepartamento= $miDB->prepare($insert1);
            $insertarDepartamento->execute();
            $insertarDepartamento= $miDB->prepare($insert2);
            $insertarDepartamento->execute();
            $insertarDepartamento= $miDB->prepare($insert3);
            $insertarDepartamento->execute();
